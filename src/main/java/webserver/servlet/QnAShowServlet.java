...
//
// public class QnAShowServlet extends Servlet {
//   Logger logger = LoggerFactory.getLogger(QnAShowServlet.class);
//
//   public QnAShowServlet(Database db, Session session) {
//     super(db, session);
//   }
//
//   @Override
...
//   @Override
//   public void doGet() {
//     String html = routeView("/qna/show.html");
//     Document doc = Jsoup.parse(html);
//     doc.getElementById("qna-list").append(makeUserTable());
